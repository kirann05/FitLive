...
export type FoodCandidate=Omit<Food,"kcal"|"protein"|"carbs"|"fat"|"fiber"> & {kcal:number|null;protein:number|null;carbs:number|null;fat:number|null;fiber:number|null;ingredients?:string};
